...
const SAMPLE_POSTS = [
  {
    ...
    comments: [{ id: "c1", text: "So cute!", timestamp: Date.now() - 36e5 }]
  },
  {
    id: "p2",
  ...
  },
  {
    ...
    likedInSession: false,
    comments: [
      { id: "c2", text: "Adorable!", timestamp: Date.now() - 72e5 }
    ]
  },
  {
    id: "p4",
  ...
  },
  {
    ...
    likedInSession: false,
    comments: [
      { id: "c3", text: "What a beauty!", timestamp: Date.now() - 108e5 }
    ]
  },
  {
    id: "p6",
...
function AppProvider({ children }) {
  const [petProfile, setPetProfileState] = reactExports.useState(
    () => loadFromStorage("dualcare_profile", null)
  );
  const [galleryPosts, setGalleryPosts] = reactExports.useState(SAMPLE_POSTS);
  const [reminders, setReminders] = reactExports.useState(
    () => loadFromStorage("dualcare_reminders", DEFAULT_REMINDERS)
  );
  const [weightLog, setWeightLog] = reactExports.useState(
    () => loadFromStorage("dualcare_weight", [])
  );
  const [vaccinationRecords, setVaccinationRecords] = reactExports.useState(() => loadFromStorage("dualcare_vaccines", []));
  ...
  const [showAddPost, setShowAddPost] = reactExports.useState(false);
  const [showPetShop, setShowPetShop] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  const setPetProfile = reactExports.useCallback((profile) => {
    setPetProfileState(profile);
  }, []);
  const addGalleryPost = reactExports.useCallback(
    (post) => {
  ...
  const toggleLike = reactExports.useCallback((postId) => {
    setGalleryPosts(
      (prev) => prev.map(
        (p) => p.id === postId ? {
          ...p,
  ...
  const addComment = reactExports.useCallback((postId, text) => {
    setGalleryPosts(
      (prev) => prev.map(
        (p) => p.id === postId ? {
          ...p,
  ...
  const updateReminder = reactExports.useCallback((reminder) => {
    setReminders(
      (prev) => prev.map((r) => r.id === reminder.id ? reminder : r)
    );
  }, []);
  const addWeightEntry = reactExports.useCallback((entry) => {
    setWeightLog((prev) => [...prev, entry]);
  }, []);
  const addVaccinationRecord = reactExports.useCallback((record) => {
    setVaccinationRecords((prev) => [...prev, record]);
  }, []);
  const addMedicalNote = reactExports.useCallback((note) => {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-xl text-foreground", children: "New Post 📸" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: imagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-medium", children: "Tap to select a photo" })
                ] })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-t border-border px-2 pb-safe", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-around py-2 relative", children: [
    TABS.slice(0, 2).map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setActiveTab(tab.id),
        className: `flex flex-col items-center gap-0.5 px-4 py-2 rounded-xl transition-all ${activeTab === tab.id ? "text-primary" : "text-muted-foreground"}`,
        ...
        children: [
          ...
          activeTab === tab.id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 w-5 h-0.5 bg-primary rounded-full" })
        ]
      },
      tab.id
    )),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center -mt-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mt-1 font-medium", children: "Post" })
    ] }),
    TABS.slice(2).map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setActiveTab(tab.id),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 pt-5 pb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-xl text-foreground", children: "Pet Shop 🛍️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 px-4 pb-3 overflow-x-auto", children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setActiveCategory(cat),
                className: `flex-shrink-0 px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${activeCategory === cat ? "bg-primary text-primary-foreground" : "bg-card text-muted-foreground border border-border"}`,
                "data-ocid": "petshop.category_tab",
                children: cat
              },
              cat
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-4 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: filtered.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-xs text-foreground leading-tight mb-1", children: product.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-secondary font-bold text-sm mb-2", children: product.price }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
...
function BotAvatar({ size = 36 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Pet doctor bot avatar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2", y: "8", width: "32", height: "24", rx: "8", fill: "#4CAF50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "2",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "18", cy: "2", r: "2", fill: "#FFB74D" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "9", y: "15", width: "6", height: "5", rx: "2", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "21", y: "15", width: "6", height: "5", rx: "2", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "17.5", r: "1.5", fill: "#1B5E20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "17.5", r: "1.5", fill: "#1B5E20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function getBotResponse(msg) {
  ...
  if (m.includes("not eating") || m.includes("won't eat") || m.includes("no appetite")) {
  ...
  if (m.includes("vaccination") || m.includes("vaccine") || m.includes("shots")) {
...
function ChatScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 pt-10 pb-4 bg-card border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BotAvatar, { size: 32 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-poppins font-bold text-lg text-foreground", children: "Pet Doctor 🩺" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary", children: "Always here to help" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Founder: NIRBHAY MAURYA" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto w-2 h-2 rounded-full bg-green-400 animate-pulse" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 space-y-4", children: [
      messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex ${msg.role === "bot" ? "justify-start" : "justify-end"} animate-slide-up`,
          children: [
            msg.role === "bot" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mr-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BotAvatar, { size: 32 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[78%]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `px-4 py-3 rounded-2xl text-sm leading-relaxed ${msg.role === "bot" ? "bg-green-50 text-foreground rounded-tl-sm border border-green-100" : "bg-primary text-primary-foreground rounded-tr-sm"}`,
                  children: msg.text
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: formatTime$1(msg.timestamp)
                }
              )
            ] })
          ]
      ...
      isTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-start animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mr-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BotAvatar, { size: 32 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-green-50 border border-green-100 px-4 py-3 rounded-2xl rounded-tl-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 items-center h-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-primary block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-primary block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-primary block" })
        ] }) })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 w-max", children: SUGGESTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 pt-2 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
        ...
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              "aria-hidden": "true",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Send" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
                    d: "M22 2L11 13",
...
function GalleryScreen() {
  const { galleryPosts, toggleLike, addComment, setShowAddPost } = useAppContext();
  ...
  const currentPost = selectedPost ? galleryPosts.find((p) => p.id === selectedPost.id) ?? selectedPost : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 pt-10 pb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-poppins font-bold text-2xl text-foreground", children: "Gallery 📸" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1 px-1 pb-6", children: galleryPosts.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-1 right-1 bg-black/50 rounded-full px-1.5 py-0.5 flex items-center gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs", children: "❤️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs", children: post.likes })
          ] })
        ]
      },
      post.id
    )) }),
    currentPost && !showComments && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium mb-3", children: currentPost.caption }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      className: `flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold transition-all ${currentPost.likedInSession ? "bg-red-100 text-red-500" : "bg-muted text-muted-foreground"}`,
                      "data-ocid": "gallery.like_button",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: currentPost.likedInSession ? "❤️" : "🤍" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: currentPost.likes })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-foreground", children: "Comments 💬" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4 space-y-3", children: currentPost.comments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              ) : currentPost.comments.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "bg-muted rounded-xl p-3",
                  "data-ocid": `gallery.comment.item.${i + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground", children: c.text }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: formatTime(c.timestamp) })
                  ]
                },
                c.id
              )) }),
...
function CatIllustration({ size = 120 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      width: size,
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Cute cat illustration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: "60",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "35,28 40,18 45,30", fill: "#FFB6C1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polygon",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "85,28 80,18 75,30", fill: "#FFB6C1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "49", cy: "48", rx: "3", ry: "5", fill: "#2C8040" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "46", r: "1", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: "71",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "71", cy: "48", rx: "3", ry: "5", fill: "#2C8040" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "72", cy: "46", r: "1", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "60,57 57,62 63,62", fill: "#E88080" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function DogIllustration({ size = 120 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      width: size,
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Cute dog illustration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: "60",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "60", cy: "52", rx: "5", ry: "3.5", fill: "#5D3A1A" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "50",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "51", cy: "44", r: "2.5", fill: "#2C1810" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "52", cy: "43", r: "0.8", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "70",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "71", cy: "44", r: "2.5", fill: "#2C1810" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "72", cy: "43", r: "0.8", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "60", cy: "63", rx: "5", ry: "4", fill: "#E57373" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function PawPrint({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Paw print" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "12", cy: "14", rx: "5.5", ry: "4.5", fill: color, opacity: "0.9" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: "7",
...
function HomeScreen() {
  const { petProfile, reminders, setActiveTab, setShowPetShop } = useAppContext();
  const dayIndex = Math.floor(Date.now() / (1e3 * 60 * 60 * 24)) % DAILY_TIPS.length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-screen px-4 pb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-10 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-poppins font-bold text-2xl text-foreground", children: "Hello, Pet Lover 🐶🐱" }),
        petProfile && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mt-0.5", children: [
          "Taking care of",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: petProfile.name }),
          " ",
          "💚"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PawPrint, { size: 22 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-2 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-float", children: (petProfile == null ? void 0 : petProfile.type) === "cat" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CatIllustration, { size: 130 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DogIllustration, { size: 130 }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-5", children: FEATURE_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-semibold text-xs text-foreground text-center leading-tight", children: card.label })
        ]
      },
      card.label
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-card p-4 mb-4 border-l-4 border-primary flex gap-3 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: tip.emoji }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-sm text-foreground mb-1", children: "Daily Tip 💡" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: tip.text })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-card p-4 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-sm text-foreground mb-3", children: "Upcoming Reminders ⏰" }),
      enabledReminders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "text-center py-4",
          "data-ocid": "home.reminders.empty_state",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No reminders set. Add them in your Profile!" })
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: enabledReminders.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center gap-3 p-2.5 bg-muted rounded-xl",
          "data-ocid": `home.reminder.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: REMINDER_ICONS[r.type] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold capitalize text-foreground", children: r.type }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: r.time })
            ] })
          ]
        },
        r.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-bold text-foreground", children: "Pet Shop 🛍️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground/70 mt-0.5", children: "Food, toys, grooming & more" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🐾" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
...
function Onboarding({ onComplete }) {
  ...
  const [isTyping, setIsTyping] = reactExports.useState(false);
  const [inputValue, setInputValue] = reactExports.useState("");
  const [petName, setPetName] = reactExports.useState("");
  const [petType, setPetType] = reactExports.useState("dog");
  const [petAge, setPetAge] = reactExports.useState("");
  const bottomRef = reactExports.useRef(null);
  const addBotMessage = reactExports.useCallback((text, delay) => {
    setTimeout(() => {
      setIsTyping(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-5 pt-10 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PawPrint, { size: 28 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-bold text-xl text-foreground", children: "Dual Care" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm ml-auto", children: "Setup" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#f97316" }, children: "Founder: NIRBHAY MAURYA" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 pb-4 space-y-3", children: [
          messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex animate-slide-up ${msg.role === "bot" ? "justify-start" : "justify-end"}`,
              children: [
                msg.role === "bot" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary flex items-center justify-center mr-2 flex-shrink-0 mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs", children: "🐾" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `max-w-[78%] px-4 py-3 rounded-2xl text-sm leading-relaxed ${msg.role === "bot" ? "bg-card text-foreground shadow-card rounded-tl-sm" : "bg-primary text-primary-foreground rounded-tr-sm"}`,
                    children: msg.text
                  }
                )
              ]
          ...
          isTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-start animate-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary flex items-center justify-center mr-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs", children: "🐾" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card shadow-card px-4 py-3 rounded-2xl rounded-tl-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 items-center h-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-muted-foreground block" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-muted-foreground block" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "typing-dot w-2 h-2 rounded-full bg-muted-foreground block" })
            ] }) })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-8 pt-2 bg-card border-t border-border", children: [
          step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", "data-ocid": "onboarding.input", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
          ...
          step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DogIllustration, { size: 64 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-semibold text-foreground", children: "Dog 🐕" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CatIllustration, { size: 64 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-semibold text-foreground", children: "Cat 🐱" })
                ]
              }
            )
          ] }),
          step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 justify-center", children: ["High", "Medium", "Low"].map((level) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          step === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 animate-float", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DogIllustration, { size: 60 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CatIllustration, { size: 60 })
          ] }) })
        ] })
      ]
    }
...
function WeightChart({
  ...
  if (last7.length < 2) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-24 text-muted-foreground text-sm", children: "Add at least 2 entries to see the chart 📈" });
  }
  const W = 280;
  const H = 120;
  const PAD = 24;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Weight over time chart" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "chartGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#4CAF50", stopOpacity: "0.25" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#4CAF50", stopOpacity: "0" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: area, fill: "url(#chartGrad)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polyline",
          {
            points,
        ...
        last7.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
...
function ProfileScreen() {
  ...
  const [activeSection, setActiveSection] = reactExports.useState("weight");
  const [showEditModal, setShowEditModal] = reactExports.useState(false);
  const [editName, setEditName] = reactExports.useState((petProfile == null ? void 0 : petProfile.name) ?? "");
  const [editType, setEditType] = reactExports.useState(
    (petProfile == null ? void 0 : petProfile.type) ?? "dog"
  );
  const [editAge, setEditAge] = reactExports.useState((petProfile == null ? void 0 : petProfile.age) ?? "");
  const [editEnergy, setEditEnergy] = reactExports.useState(
    (petProfile == null ? void 0 : petProfile.energyLevel) ?? "Medium"
  );
  const [weightDate, setWeightDate] = reactExports.useState(
    (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)
  );
  const [weightValue, setWeightValue] = reactExports.useState("");
  const [vacDate, setVacDate] = reactExports.useState((/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
  const [vacName, setVacName] = reactExports.useState("");
  const [vacNotes, setVacNotes] = reactExports.useState("");
  ...
  const isOverdue = (r) => {
    ...
    const doneToday = r.lastDone ? new Date(r.lastDone).toDateString() === today : false;
    return now2 > reminderTime && !doneToday;
  };
  const handleMarkDone = (id) => {
    const r = reminders.find((x2) => x2.id === id);
  ...
  const exportReport = () => {
    const lines = [
      ...
      "",
      "--- PET PROFILE ---",
      `Name: ${(petProfile == null ? void 0 : petProfile.name) ?? "N/A"}`,
      `Type: ${(petProfile == null ? void 0 : petProfile.type) ?? "N/A"}`,
      `Age: ${(petProfile == null ? void 0 : petProfile.age) ?? "N/A"} years`,
      `Energy Level: ${(petProfile == null ? void 0 : petProfile.energyLevel) ?? "N/A"}`,
      "",
      "--- WEIGHT LOG ---",
      ...
      "",
      "--- VACCINATION RECORDS ---",
      ...vaccinationRecords.map((v2) => `${v2.date} | ${v2.vaccine} | ${v2.notes}`),
    ...
    a.href = url;
    a.download = `${(petProfile == null ? void 0 : petProfile.name) ?? "pet"}-health-report.txt`;
    a.click();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-screen px-4 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 bg-card rounded-2xl shadow-card p-5 flex items-center gap-4 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: (petProfile == null ? void 0 : petProfile.type) === "cat" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CatIllustration, { size: 80 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DogIllustration, { size: 80 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-xl text-foreground", children: (petProfile == null ? void 0 : petProfile.name) ?? "My Pet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 bg-primary/10 text-primary rounded-full font-medium capitalize", children: (petProfile == null ? void 0 : petProfile.type) ?? "pet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs px-2 py-0.5 bg-secondary/30 text-foreground rounded-full font-medium", children: [
            petProfile == null ? void 0 : petProfile.age,
            " yrs"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: `text-xs px-2 py-0.5 rounded-full font-medium ${ENERGY_COLORS[(petProfile == null ? void 0 : petProfile.energyLevel) ?? "Medium"]}`,
              children: [
                "⚡ ",
                petProfile == null ? void 0 : petProfile.energyLevel
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => {
            setEditName((petProfile == null ? void 0 : petProfile.name) ?? "");
            setEditType((petProfile == null ? void 0 : petProfile.type) ?? "dog");
            setEditAge((petProfile == null ? void 0 : petProfile.age) ?? "");
            setEditEnergy((petProfile == null ? void 0 : petProfile.energyLevel) ?? "Medium");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-card p-4 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-foreground", children: "Health Tracking 📊" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 p-1 bg-muted rounded-xl mb-4", children: ["weight", "vaccines", "notes"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => setActiveSection(s),
          className: `flex-1 py-2 rounded-lg text-xs font-semibold capitalize transition-all ${activeSection === s ? "bg-card text-primary shadow-xs" : "text-muted-foreground"}`,
          "data-ocid": `profile.${s}_tab`,
          children: s === "weight" ? "⚖️ Weight" : s === "vaccines" ? "💉 Vaccines" : "📝 Notes"
        },
        s
      )) }),
      activeSection === "weight" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(WeightChart, { entries: weightLog }),
        ...
        weightLog.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-1 max-h-32 overflow-y-auto", children: [...weightLog].reverse().map((w) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex justify-between text-xs py-1.5 px-3 bg-muted rounded-lg",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: w.date }),
      ...
      activeSection === "vaccines" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        vaccinationRecords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-center text-muted-foreground text-xs py-4",
            "data-ocid": "profile.vaccines.empty_state",
            children: "No records yet. Add your first! 💉"
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-40 overflow-y-auto", children: [...vaccinationRecords].reverse().map((v2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-muted rounded-xl p-3",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-xs text-foreground", children: v2.vaccine }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: v2.date })
              ] }),
              v2.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: v2.notes })
            ]
          },
          `${v2.date}-${v2.vaccine}`
        )) })
      ] }),
      activeSection === "notes" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        medicalNotes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-center text-muted-foreground text-xs py-4",
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: [...medicalNotes].reverse().map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted rounded-xl p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground", children: n.text }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: n.date })
        ] }, n.id)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-card p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-foreground mb-3", children: "Reminders ⏰" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: reminders.map((r, i) => {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: meta.label }),
                    overdue && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 bg-red-100 text-red-600 rounded-full font-bold", children: "OVERDUE" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "time",
                      value: r.time,
                      onChange: (e) => updateReminder({ ...r, time: e.target.value }),
              ...
              r.enabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            onKeyDown: (e) => e.stopPropagation(),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-bold text-lg text-foreground mb-4", children: "Edit Profile ✏️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground mb-1", children: "Pet Type" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["dog", "cat"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setEditType(t),
                      className: `flex-1 py-2 rounded-xl text-sm font-semibold capitalize border-2 transition-colors ${editType === t ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground"}`,
                      "data-ocid": `profile.edit_type_${t}_button`,
                      children: t === "dog" ? "🐕 Dog" : "🐱 Cat"
                    },
                    t
                  )) })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground mb-1", children: "Energy Level" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["High", "Medium", "Low"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setEditEnergy(l),
                      className: `flex-1 py-2 rounded-xl text-xs font-semibold border-2 transition-colors ${editEnergy === l ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground"}`,
...
function MainApp() {
  ...
  const [onboardingDone, setOnboardingDone] = reactExports.useState(!!petProfile);
  if (!onboardingDone) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Onboarding, { onComplete: () => setOnboardingDone(true) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mobile-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: activeTab === "home" ? "block" : "hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: activeTab === "gallery" ? "block" : "hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryScreen, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: activeTab === "chat" ? "block" : "hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatScreen, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: activeTab === "profile" ? "block" : "hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileScreen, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {}),
    showAddPost && /* @__PURE__ */ jsxRuntimeExports.jsx(AddPostModal, {}),
    showPetShop && /* @__PURE__ */ jsxRuntimeExports.jsx(PetShopModal, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, {})
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MainApp, {}) });
}
...
const Time = Int;
const MedicalNote = Record({ "date": Time, "text": Text });
...
const VaccinationRecord = Record({
  "date": Time,
  "vaccineName": Text,
  "notes": Text
});
const WeightLog = Record({ "weight": Float64, "date": Time });
const PetProfile = Record({
  "age": Nat,
  "name": Text,
  "energyLevel": Nat,
  "petType": Text
...
Service({
  "addGalleryPost": Func([GalleryPost], [], []),
  "addMedicalNote": Func([MedicalNote], [], []),
  "addReminder": Func([Reminder], [], []),
  "addVaccinationRecord": Func([VaccinationRecord], [], []),
  "addWeightLog": Func([WeightLog], [], []),
  "deleteGalleryPost": Func([Nat], [], []),
  "deleteMedicalNote": Func([Time], [], []),
  "deleteReminder": Func([Nat], [], []),
  "deleteVaccinationRecord": Func([Time], [], []),
  "deleteWeightLog": Func([Time], [], []),
  "getAllGalleryPosts": Func([], [Vec(GalleryPost)], ["query"]),
  "getAllMedicalNotes": Func([], [Vec(MedicalNote)], ["query"]),
  "getAllReminders": Func([], [Vec(Reminder)], ["query"]),
  "getAllVaccinationRecords": Func(
    [],
    [Vec(VaccinationRecord)],
    ["query"]
  ),
  "getAllWeightLogs": Func([], [Vec(WeightLog)], ["query"]),
  "getGalleryPost": Func([Nat], [GalleryPost], ["query"]),
  "getMedicalNote": Func([Time], [MedicalNote], ["query"]),
  "getPetProfile": Func([], [Opt(PetProfile)], ["query"]),
  "getReminder": Func([Nat], [Reminder], ["query"]),
  "getVaccinationRecord": Func([Time], [VaccinationRecord], ["query"]),
  "getWeightLog": Func([Time], [WeightLog], ["query"]),
  "setPetProfile": Func([PetProfile], [], []),
  "updateGalleryPost": Func([GalleryPost], [], []),
  "updateMedicalNote": Func([MedicalNote], [], []),
  "updateReminder": Func([Reminder], [], []),
  "updateVaccinationRecord": Func([VaccinationRecord], [], []),
  "updateWeightLog": Func([WeightLog], [], [])
});
